...
export const WeatherFunctionDefinition = {
  name: "get_weather",
  description: "Determine weather and current temperature in my location",
  parameters: {
    type: "object",
    properties: {
      location: {
...
export const getCustomerProductsRevenueFunctionDefinition = {
  ...
  description: 'Gets the revenue of the customers and products. The result is ordered by the revenue in descending order. The result list is limited to 25 records.',
  parameters: {
      type: 'object',
      properties: {
          customerID: { type: 'integer', description: 'Optional filter for the customer ID.' },
